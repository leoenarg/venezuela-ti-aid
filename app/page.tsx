        ...
        <div className="grid flex-1 content-center gap-8 py-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-lg leading-7 text-neutral-700">
              Reportes ciudadanos con búsqueda privada por cédula y fecha de nacimiento. Sin directorios públicos de nombres.
            </p>
          </div>

          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4" aria-label="Estadísticas públicas">
  ...
  return (
    <div className="fixed inset-0 z-10 grid place-items-end bg-black/40 p-3 sm:place-items-center" role="dialog" aria-modal="true">
      <section className="w-full max-w-xl rounded-md bg-white p-5 shadow-xl">
        <h2 className="text-xl font-black">Términos y uso humanitario</h2>
        <p className="mt-3 leading-7 text-neutral-700">
          La información es enviada por la comunidad para fines de alivio humanitario y reunificación familiar. Está prohibido usar estos datos para acoso, persecución, comercio, extorsión, difusión pública no autorizada o reportes falsos.
        </p>
        <p className="mt-3 leading-7 text-neutral-700">
          Toda búsqueda requiere coincidencia exacta de cédula y fecha de nacimiento. El mal uso de la plataforma puede poner en riesgo a personas vulnerables.
        </p>
